      ...
      <section className="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mt-6 space-y-4 text-base leading-7 text-slate-700">
          <p>
            ...
            customers provide the backbone to achieve this goal. We believe that
            honesty in all aspects of the company and its employees, is the most
            critical factor in the services we provide.
          </p>
          <p>
          ...
          <p>
            ...
            painting services at a fair price. Our mission is built on ensuring
            satisfaction for both our customers and employees, as we believe
            this is the foundation of our success. Honesty and integrity, in
            every aspect of our business, are at the core of the services we
            provide.
          </p>
        </div>
      </section>
